...
class SignUpModel extends model_1.Model {
    constructor(body) {
        super();
        const { firstName, lastName, mobileNo, email, password, address } = body;
        this.email = email;
        this.password = password;
